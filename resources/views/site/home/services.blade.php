            ...
            <article class="item">
              ...
              <div class="content">
                <div class="col-xs-12 no-side-padding">
                  ...
                  <p>VENTAJAS:<br/>
                  Algunas de las grandes ventajas de usar pasto sintético residencial:</p>
                </div>
                <div class="col-xs-12 no-side-padding">
                  <div class="col-xs-4 no-side-padding">
                    <p>Libre de riego</p>
                ...
                <div class="col-xs-12 no-side-padding">
                  <p>BENEFICIOS:<br/>
                  Nuestros pastos sintéticos brindan los siguientes beneficios:</p>
