...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="{!! asset('public/assets/img/img-carousel-inicio-1.png') !!}" alt="...">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="{!! asset('public/assets/img/img-carousel-inicio-2.png') !!}" alt="...">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="{!! asset('public/assets/img/img-carousel-inicio-3.png') !!}" alt="...">
      <div class="carousel-caption">
      </div>
    </div>
  </div>
